...
class UserManager(BaseUserManager):
    def create_user(self, email, name, first_name, last_name, otp , password=None, password2 = None):             ##
        """
    ...
    def create_superuser(self, email, name,first_name, last_name, otp, password=None):            
        """
...
class User(AbstractBaseUser):
    ...
    REQUIRED_FIELDS = ['name','otp','first_name','last_name']                         
